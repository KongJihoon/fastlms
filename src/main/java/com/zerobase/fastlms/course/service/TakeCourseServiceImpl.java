...
import static com.zerobase.fastlms.course.entity.TakeCourseCode.STATUS_CANCEL;

@Service
@RequiredArgsConstructor
public class TakeCourseServiceImpl implements TakeCourseService {

    public final TakeCourseRepository takeCourseRepository;
    public final TakeCourseMapper takeCourseMapper;
